    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/myAccount/{mail}").access(new WebExpressionAuthorizationManager("#mail == authentication.name && hasAuthority('VIEWACCOUNT')")) //si el mail del parametro coincide con el de la autenticación y el usuario tiene el rol. se podra acceder
