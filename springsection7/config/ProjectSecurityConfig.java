    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .sessionManagement((smc) -> {
                    ...
                    /*
                    smc.sessionFixation(sfc->{
                        //sfc.newSession(); una de las opciones que te ofrece springSecurity
                        //sfc.none(); no se recomienda hacer si no tienes una estrategia de autenticacion
                    });
                    */
                })
